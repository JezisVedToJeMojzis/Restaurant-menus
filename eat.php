...
$_SESSION['eatMonday'] = $jedla[0];
$_SESSION['eatTuesday'] = $jedla[1];
$_SESSION['eatWednesday'] = $jedla[2];
$_SESSION['eatThursday'] = $jedla[3];
$_SESSION['eatFriday'] = $jedla[4];
$_SESSION['eatSaturday'] = $jedla[5];
$_SESSION['eatSunday'] = $jedla[6];
